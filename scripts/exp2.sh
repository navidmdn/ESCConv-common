...
--validation_file original_data/valid_ann_extes.json --do_train --model_name_or_path google/flan-t5-small --output_dir ./output/exp2-flan --overwrite_output_dir \
...
--max_source_length 300 --gradient_accumulation_steps 4 --learning_rate 1e-5 --warmup_steps 600 --fp16
