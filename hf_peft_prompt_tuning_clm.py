...
def main():
    ...
    if tokenizer.pad_token is None:
        ...
        logger.warning("The tokenizer didn't have a pad token, so we added a new token: <pad> to the tokenizer.")

    strategy_list = get_strategy(data_args.strategy_file, norm=False)
